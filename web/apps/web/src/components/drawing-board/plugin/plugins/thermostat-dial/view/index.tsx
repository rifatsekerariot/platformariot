...
const View = (props: Props) => {
    ...
    return (
        <div
            ref={containerRef}
            className={cls('ms-thermostat-dial', {
                'ms-thermostat-dial--preview': isPreview,
            })}
        >
            <div className="ms-thermostat-dial__card">
                <div
                    className={cls('ms-thermostat-dial__header', {
                        'mb-1': matchTablet,
                        'mb-2': !matchTablet,
                    })}
                >
                    <Tooltip className="ms-thermostat-dial__title" autoEllipsis title={title} />
                </div>
                <div className="ms-thermostat-dial__body">
                    <div className={cls('ms-thermostat-dial__value', { 'text-lg': wGrid > 1 && hGrid > 1 })}>
